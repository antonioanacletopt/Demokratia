...
// Inicialização robusta do plugin
...
// Referência de modelo via plugin para garantir resolução correta do ID
const geminiModel = googleAIPlugin.model('gemini-1.5-flash');
