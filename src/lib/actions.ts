 ...
 * 
 * Resolução do erro "Unknown action type" utilizando o helper googleAI.model() 
 * e chamadas directas para máxima estabilidade no Next.js.
 */
...
// Referência oficial de modelo para evitar falhas de registo no servidor
