 ...
 * Fixed "Unknown action type" error by using direct model references from the plugin helper.
 */
...
// Stable model reference to prevent "Unknown action type" errors in Next.js Server Actions
