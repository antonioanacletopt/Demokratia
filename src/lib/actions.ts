 ...
 * Using direct ai.generate calls to ensure maximum stability in Next.js Server Actions
 * by avoiding registry lookup issues common with ai.definePrompt in dynamic environments.
 */
